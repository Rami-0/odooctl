...
- `odooctl rollback production --mode code`: check out the last successfully deployed commit recorded in `.odooctl/deployments/` for the environment, then redeploy the Odoo service. This does not restore database or filestore state.
